...
public class ESClients {
    ...
    public static RestClient getInstance(String project, String cluster) {
        ...
        return getNewRestClient("10.138.238.180:9200,10.138.238.181:9200,10.138.238.182:9200");
    }
    ...
    private static RestClient getNewRestClient(String esAddress) {
        RestClient restClient = RestClient
                .builder(EnvionmentVariables.getHttpHostArray(esAddress)).build();
    ...
    private enum ESClientLRUCacheSingleton {
        ...
        ESClientLRUCacheSingleton() {
            esClientLRUCache = new ESClientLRUCache<>(MapUtils.getSize(100));
        }
