...
# 不要忘记了 暴露端口
#CMD ["java","-server","-Xms4096m","-Xmx4096m","-Xmx3072m","-XX:CompressedClassSpaceSize=512m","-XX:MetaspaceSize=512m","-XX:MaxMetaspaceSize=512m","-Dcom.sun.management.jmxremote.rmi.port=1099","-Dcom.sun.management.jmxremote=true","-Dcom.sun.management.jmxremote.port=1099","-Dcom.sun.management.jmxremote.ssl=false","-Dcom.sun.management.jmxremote.authenticate=false","-Dcom.sun.management.jmxremote.local.only=false","-Djava.rmi.server.hostname=127.0.0.1","-Xlog:gc*","-jar","application.jar"]
